...
#[test]
#[ignore = "Spawns cargo check in a fresh tempdir (cold-builds windjammer-runtime; often minutes). Run: cargo test -p windjammer --test integration_test_helpers_self_test -- --ignored"]
