...
"#;
    ...
    assert!(
        rust_code.contains("id: 1_u32")
            || (rust_code.contains("id: 1") && !rust_code.contains("id: 1_i32")),
        "Should generate u32 literal for u32 field\nGenerated:\n{}",
        rust_code
    );

    assert!(
        rust_code.contains("health: 100_u32")
            || (rust_code.contains("health: 100") && !rust_code.contains("health: 100_i32")),
        "Should generate u32 literal for u32 field\nGenerated:\n{}",
        rust_code
    );
