...
"#;
    ...
    assert_eq!(
        test_attr_count, 2,
        "Expected 2 #[test] attributes, found {}",
        test_attr_count
    );

    // Should generate test functions
    assert!(
        generated_rust.contains("pub fn test_example()"),
        "Expected test_example function"
    );
    assert!(
        generated_rust.contains("pub fn test_another()"),
...
"#;
    ...
    assert!(
        generated_rust.contains("use windjammer_runtime::test::*")
...
"#;
    ...
    assert_eq!(
        test_attr_count, 1,
        "Only test_valid should get #[test], found {} attributes",
        test_attr_count
    );
}
...
"#;
    ...
    assert!(
        result_test_file.contains("#[test]"),
    ...
    assert!(
        !result_regular_file.contains("#[test]"),
