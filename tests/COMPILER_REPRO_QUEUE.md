...
| P1 | **`for zi in 0..(zd + 1)` emits `zd as i64 + 1_i32` (`mesh_primitives`)** | `bug_i32_range_end_add_must_not_split_i64_i32_test` | 🆕 RED / filed (P3.312) |
| P1 | **`for x in 0..(zd + 1)` with `zd: i32` emits `zd as i64 + 1_i32`** | `bug_i32_range_end_add_must_not_split_i64_i32_test` | 🆕 RED / filed (P3.312); mesh_primitives range end |
...
**Gates:** `cargo test --release --test all -- auto_mut_borrow_arg_test`; lib `mut_borrowed_vec_is_not_runtime_shared_borrow` + `mut_borrowed_bare_vec_stays_mut_ref_at_call_site`

## P3.312 (2026-09-16) — i32 range end `zd + 1` emits `zd as i64 + 1_i32`
