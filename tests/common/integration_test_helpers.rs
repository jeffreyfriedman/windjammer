...
//!
//! Shared via `#[path = "../common/integration_test_helpers.rs"] mod integration_test_helpers;`
//! from each suite under `tests/*/` (or `#[path = "../../common/integration_test_helpers.rs"]` under
//! `tests/codegen/*/`).
//!
