...
"#;
    ...
    let generated = fs::read_to_string("./build/test_format.rs")
        .expect("Failed to read generated file");

    // Should contain format! macro as-is
    assert!(generated.contains("format!"), 
            "Generated code should contain format! macro");
    assert!(generated.contains(r#""The answer is {}""#), 
...
"#;
    ...
    let generated = fs::read_to_string("./build/test_format_call.rs")
        .expect("Failed to read generated file");

    println!("Generated code:\n{}", generated);

    // Should contain format! macro in function call
    assert!(generated.contains("log_message(format!"), 
