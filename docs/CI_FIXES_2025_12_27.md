...
This increases Windows stack to **16MB** (16777216 bytes), providing safety margin for debug builds.
...
2. ✅ **Ubuntu race condition** - Add `sync_data()` on Linux only  
3. ✅ **Windows stack overflow** - Increase stack size to 8MB
