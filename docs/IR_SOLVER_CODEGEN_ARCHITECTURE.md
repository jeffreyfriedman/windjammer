...
Remaining: delete legacy `!call_sites` paths when opt-out is retired; fold remaining method-path shared-borrow / copy-aggregate patches into reconcile where safe.
