...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/jeffreyfriedman/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/jeffreyfriedman/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/jeffreyfriedman/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.92.0-nightly (595b9a498 2025-10-03)";
#[doc=r#"The output of `/Users/jeffreyfriedman/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/jeffreyfriedman/.rustup/toolchains/nightly-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.92.0-nightly (595b9a498 2025-10-03)";
