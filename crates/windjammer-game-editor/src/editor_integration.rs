...
pub struct GameEditorPanels {
    ...
    pub weapon_editor: WeaponEditor,
    pub navmesh_editor: NavMeshEditor,
...
impl Default for GameEditorPanels {
    fn default() -> Self {
        Self {
            ...
            animation_editor: AnimationEditor::new(),
            ...
            weapon_editor: WeaponEditor::new(),
            navmesh_editor: NavMeshEditor::new(),
