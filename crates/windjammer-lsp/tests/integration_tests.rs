...
"#;
        ...
        assert!(
            ast.is_ok(),
            "Program with various keywords should parse correctly"
        );
...
"#;
        ...
        assert!(
            ast.is_ok(),
            "Program with multiple function calls should parse"
        );
...
"#;
        ...
        assert!(
            ast.is_ok(),
            "Program with struct instantiations should parse"
        );
...
mod diagnostics_tests {
    ...
    fn test_syntax_error_detection() {
        ...
        assert!(
            !tokens.is_empty(),
            "Lexer should tokenize incomplete statement"
        );
        ...
        assert!(
            ast.is_err(),
            "Parser should detect missing value in let statement"
        );
...
"#;
        ...
        assert!(
            ast.is_ok(),
            "Program should parse for extract function action"
        );
...
"#;
        ...
        assert!(
            ast.is_ok(),
            "Program should parse for inline variable action"
        );
...
mod edge_case_tests {
    ...
    fn test_file_with_only_comments() {
        ...
        if let Ok(prog) = ast {
            assert!(
                prog.items.is_empty(),
                "Comment-only file should have no items"
            );
        } else {
