...
fn test_all_22_stdlib_modules_accounted_for() {
    ...
    let modules = vec![
        "async", "cli", "collections", "crypto", "csv",
        "db", "encoding", "env", "fs", "http",
        "json", "log", "math", "mime", "process",
        "random", "regex", "strings", "testing", "time",
    ...
    assert!(modules.len() >= 20, "We should have at least 20 stdlib modules");
}
