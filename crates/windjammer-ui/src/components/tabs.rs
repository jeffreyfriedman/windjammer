...
impl Tabs {
    ...
    pub fn render(&self) -> VNode {
        let tab_headers: Vec<VNode> = self.tabs.iter().enumerate().map(|(i, tab)| {
        ...
        VNode::Element {
            tag: "div".to_string(),
            attrs: vec![
                ("class".to_string(), VAttr::Static("wj-tabs".to_string())),
            ],
            children: vec![
                VNode::Element {
                    tag: "div".to_string(),
                    attrs: vec![
                        ("class".to_string(), VAttr::Static("wj-tabs-headers".to_string())),
                        ("style".to_string(), VAttr::Static("display: flex; gap: 4px; border-bottom: 1px solid #ddd;".to_string())),
                    ],
                ...
                VNode::Element {
                    tag: "div".to_string(),
                    attrs: vec![
                        ("class".to_string(), VAttr::Static("wj-tabs-content".to_string())),
                    ],
