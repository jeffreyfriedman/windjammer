...
pub mod simd_codegen; // Automatic SIMD vectorization code generation
...
pub mod runtime_optimizer; // Runtime optimization for ALL SDKs (Python, JS, etc.)
pub mod sdk_codegen; // SDK code generator for multi-language bindings
pub mod sdk_ffi; // C FFI layer for multi-language bindings
...
pub mod prelude {
    ...
    pub use crate::batching::{
        Batch, BatchConfig, BatchManager, BatchSorter, BatchStats, BatchType, DrawInstance,
        MaterialId, MeshId,
    }; // Runtime batching
    ...
    pub use crate::sdk_ffi::{
        WjColor, WjComponent, WjEngine, WjEntity, WjErrorCode, WjRect, WjResult, WjVec2, WjVec3,
        WjVec4, WjWindow,
    }; // C FFI Layer
