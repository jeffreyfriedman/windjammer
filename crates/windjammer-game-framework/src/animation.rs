...
impl Skeleton {
    ...
    pub fn add_bone(&mut self, name: String, parent: Option<usize>, local_transform: Transform, inverse_bind_pose: Mat4) -> usize {
...
impl AnimationBlender {
    ...
    pub fn blend(&self, time: f32) -> Vec<Transform> {
        ...
        // Normalize weights
        let weights: Vec<f32> = self.animations.iter()
...
impl IKChain {
    ...
    pub fn solve(&self, skeleton: &mut Skeleton) {
        ...
        // Get bone positions
        let mut positions: Vec<Vec3> = self.bones.iter()
...
mod tests {
    ...
    fn test_skeleton_creation() {
        ...
        let _child = skeleton.add_bone(
            "child".to_string(),
            Some(root),
            Transform::new(Vec3::new(0.0, 1.0, 0.0), Quat::IDENTITY, Vec3::new(1.0, 1.0, 1.0)),
            Mat4::IDENTITY,
        );
    ...
    fn test_animation_sampling() {
        ...
        animation.add_keyframe(1.0, vec![Transform::new(
            Vec3::new(1.0, 0.0, 0.0),
            Quat::IDENTITY,
            Vec3::new(1.0, 1.0, 1.0),
        )]);
        animation.add_keyframe(2.0, vec![Transform::new(
