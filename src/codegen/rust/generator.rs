...
impl<'ast> CodeGenerator<'ast> {
    ...
    pub(in crate::codegen::rust) fn enter_recursion(&mut self, context: &str) -> Result<(), String> {
    ...
    pub(in crate::codegen::rust) fn exit_recursion(&mut self) {
    ...
    pub fn new(registry: SignatureRegistry, target: CompilationTarget) -> Self {
        ...
        CodeGenerator {
            ...
            stdlib_method_signatures: crate::codegen::rust::stdlib_method_signatures::init_stdlib_method_signatures(),
    ...
    pub(in crate::codegen::rust) fn generate_inline_module_item(
        &mut self,
        item: &Item<'ast>,
    ...
    pub(in crate::codegen::rust) fn record_mapping(&mut self, wj_location: &crate::source_map::Location) {
    ...
    #[allow(dead_code)]
    pub(in crate::codegen::rust) fn track_generated_lines(&mut self, code: &str) {
