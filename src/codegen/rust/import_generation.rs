            ...
            if rust_path.ends_with("::*") {
                ...
                if rust_path.starts_with("crate::") {
                        ...
                        .is_some_and(|c| c.is_uppercase())
                    {
                        ...
                        let common_internal_modules = [
                            "math", "physics", "rendering", "world", "game", "audio",
                            "input", "rpg", "ui", "editor", "scene", "collision2d",
                            "networking", "effects", "animation", "ai", "dialogue",
                            "inventory", "quest", "combat", "lighting", "camera",
                            "particles", "terrain", "weather", "save", "config",
                            "debug", "utils", "helpers", "core", "common", "types",
                            "components", "systems", "resources", "entities", "events",
                            "state", "assets", "data", "models", "controllers",
                            "views", "managers", "services", "handlers", "processors",
                        ];
