...
// Phase 5: `correct_legacy_output` / `is_typed_lowering_enabled` deleted.
// Call-site coercion is owned by `ir_call_site::apply_ir_call_site_coercion`.
// Unit tests below still exercise `compute_arg_coercion` (IR coercion engine).
