...
const MUTATES_RECEIVER: &[&str] = &[
    "push", "pop", "insert", "remove", "clear", "append", "extend", "drain", "truncate", "resize",
    "retain", "sort", "sort_by", "sort_by_key", "sort_unstable", "sort_unstable_by", "dedup",
    "reverse", "swap", "swap_remove", "reserve", "shrink_to_fit", "split_off", "fill", "set",
    "rotate_left", "rotate_right", "set_len", "push_str", "push_front", "push_back", "pop_front",
    "pop_back", "make_ascii_lowercase", "make_ascii_uppercase", "add", "take", "replace",
    "get_or_insert", "get_or_insert_with", "entry", "get_mut", "iter_mut", "values_mut",
];

const KNOWN_READONLY: &[&str] = &[
    "contains_key", "get", "get_key_value", "len", "is_empty", "contains", "first", "last",
    "capacity", "keys", "values", "binary_search", "to_le_bytes", "to_be_bytes", "from_le_bytes",
    "from_be_bytes", "iter", "into_iter", "windows", "chunks", "enumerate", "lines", "chars",
    "bytes", "split", "split_whitespace", "clone", "to_string", "to_owned", "to_vec", "as_str",
    "as_ref", "as_slice", "as_bytes", "as_deref", "as_ptr", "as_mut_ptr", "trim", "starts_with",
    "ends_with", "to_lowercase", "to_uppercase", "is_ascii", "substring", "splitn", "rsplit",
    "repeat", "replacen", "rfind", "match_indices", "trim_start", "trim_end", "strip_prefix",
    "strip_suffix", "to_ascii_lowercase", "to_ascii_uppercase", "slice", "reversed",
    "extend_from_slice", "count", "with_capacity", "abs", "ceil", "floor", "round", "sqrt", "cbrt",
    "powi", "powf", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "sinh", "cosh", "tanh",
    "asinh", "acosh", "atanh", "log", "log2", "log10", "ln", "exp", "exp2", "min", "max", "clamp",
    "signum", "copysign", "fract", "recip", "to_radians", "to_degrees", "is_nan", "is_infinite",
    "is_finite", "is_normal", "is_sign_positive", "is_sign_negative", "leading_zeros",
    "trailing_zeros", "count_ones", "count_zeros", "wrapping_add", "wrapping_sub", "wrapping_mul",
    "saturating_add", "saturating_sub", "saturating_mul", "checked_add", "checked_sub",
    "checked_mul", "checked_div", "display", "fmt", "cmp", "partial_cmp", "eq", "ne", "is_some",
    "is_none", "is_ok", "is_err", "unwrap", "unwrap_or", "unwrap_or_else", "unwrap_or_default",
    "expect", "map", "and_then", "or_else", "ok_or", "ok_or_else", "filter", "any", "all", "find",
    "find_map", "position", "take_while", "skip_while", "map_while", "partition", "rposition",
];

const MAP_KEY: &[&str] = &["remove", "contains_key", "get", "get_mut", "get_key_value"];

const STORAGE: &[&str] = &["push", "insert", "extend", "append", "add", "push_front", "push_back"];
...
const COMMON_STDLIB_NAMES: &[&str] = &[
    "push", "pop", "insert", "remove", "clear", "get", "get_mut", "set", "len", "is_empty",
    "contains", "contains_key", "first", "last", "iter", "keys", "values", "clone", "to_string",
    "starts_with", "ends_with", "binary_search", "add", "to_le_bytes", "to_be_bytes",
